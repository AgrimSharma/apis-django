...
DEBUG = True if env('DEBUG', False) is not False else False
...
MIDDLEWARE = [
    ...
    'doctorbox_web.api.middleware.PatientDeviceMiddleware',
...
ROOT_URLCONF = 'doctorbox_web.urls'
...
WSGI_APPLICATION = 'doctorbox_web.wsgi.application'
